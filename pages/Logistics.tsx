...
export const Logistics: React.FC = () => {
  ...
  return (
    <div className="bg-white font-sans text-gray-900 selection:bg-primary selection:text-white pt-20">
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="lg:w-1/2 relative z-10">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 text-primary text-xs font-bold tracking-widest uppercase mb-6">
              ...
              <div className="flex flex-wrap gap-4">
                <button 
                  ...
                  className="px-8 py-4 bg-primary text-white font-bold rounded-lg shadow-lg hover:bg-primaryLight transition-all flex items-center gap-2"
                >
                  Explore Air Routes <ArrowRight size={18} />
                </button>
                <button 
                   onClick={() => document.getElementById('lead-form')?.scrollIntoView({ behavior: 'smooth' })}
                   className="px-8 py-4 bg-white text-primary border-2 border-primary/10 font-bold rounded-lg hover:border-primary hover:bg-blue-50 transition-all"
                >
                  Get a Freight Quote
                </button>
              </div>
            ...
            <div className="lg:w-1/2 relative">
              ...
              {/* Decorative Element */}
              <div className="absolute -z-10 top-10 -right-10 w-full h-full border-2 border-primary/5 rounded-2xl"></div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
            ...
            <button className="text-primary font-bold flex items-center gap-2 hover:gap-4 transition-all">
              Review Compliance Docs <ArrowRight size={18} />
            </button>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 hover:shadow-lg transition-all group">
                <div className="w-12 h-12 bg-secondary rounded-lg flex items-center justify-center text-primary mb-6 group-hover:bg-primary group-hover:text-white transition-colors">
                  <item.icon size={24} />
                </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:-translate-y-2 transition-transform duration-300">
              <div className="h-56 relative">
                 <img src="https://images.unsplash.com/photo-1534958946933-780c7a523a9d?q=80&w=2069&auto=format&fit=crop" alt="Russian Vessel" className="w-full h-full object-cover" />
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:-translate-y-2 transition-transform duration-300">
               <div className="h-56 relative">
                 <img src="https://images.unsplash.com/photo-1578635882875-c54d24597b69?q=80&w=2000&auto=format&fit=crop" alt="Incheon Airport" className="w-full h-full object-cover" />
                 <div className="absolute bottom-0 left-0 w-full p-4 bg-gradient-to-t from-black/80 to-transparent">
                   <div className="flex items-center gap-2 text-white/90 text-sm font-bold">
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:-translate-y-2 transition-transform duration-300">
               <div className="h-56 relative">
                 <img src="https://images.unsplash.com/photo-1600880302636-f046200673d4?q=80&w=2000&auto=format&fit=crop" alt="KL Airport" className="w-full h-full object-cover" />
                 <div className="absolute bottom-0 left-0 w-full p-4 bg-gradient-to-t from-black/80 to-transparent">
                   <div className="flex items-center gap-2 text-white/90 text-sm font-bold">
      ...
      <section className="py-20 bg-primary text-white text-center">
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <button 
              onClick={() => document.getElementById('lead-form')?.scrollIntoView({ behavior: 'smooth' })}
              className="bg-accent hover:bg-orange-600 text-white px-10 py-4 rounded-lg font-bold text-lg transition-colors uppercase tracking-wider"
            >
              Request Freight Quote
            </button>
            <Link 
              to="/#lead-form"
              className="bg-transparent border border-white/30 hover:bg-white/10 text-white px-10 py-4 rounded-lg font-bold text-lg transition-colors uppercase tracking-wider"
            >
              Contact Sales
            </Link>
          </div>
      ...
      {/* Embedded Lead Form for context */}
      <section id="lead-form" className="bg-secondary">
          {/* Form component is handled by main page import */}
      </section>
    </div>
  );
};