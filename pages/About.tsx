    ...
    <div className="bg-[#0b0f19] text-gray-300 font-sans selection:bg-accent selection:text-white">
      ...
      <section className="relative h-screen min-h-[700px] w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center max-w-4xl pt-20">
          <h1 className="text-5xl md:text-7xl font-serif font-bold text-white mb-8 tracking-tight drop-shadow-lg">
            Our Deep Sea Legacy
          </h1>
          <div className="w-24 h-1 bg-accent mx-auto mb-8"></div>
          <p className="text-lg md:text-xl text-white/90 leading-relaxed mb-8 font-light drop-shadow-md">
          ...
          <p className="text-md md:text-lg text-white/80 leading-relaxed mb-12 font-light max-w-3xl mx-auto">
          ...
          <button 
            ...
            className="group bg-white/10 hover:bg-white text-white hover:text-primary border border-white px-8 py-3 rounded-full transition-all duration-300 backdrop-blur-sm flex items-center gap-2 mx-auto"
          >
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col items-center">
            <div className="mb-12 relative w-full max-w-4xl">
               {/* Crab Image Layer */}
               <img 
                 src="https://pngimg.com/d/crab_PNG32.png" 
                 alt="Red King Crab" 
            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              <button 
                ...
                className="bg-accent hover:bg-orange-600 text-white px-8 py-3 rounded-full font-medium transition-all shadow-[0_0_20px_rgba(255,69,0,0.3)] flex items-center gap-2 mx-auto"
              >
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="w-16 h-16 mx-auto bg-white/10 rounded-full flex items-center justify-center border border-white/20 mb-8 backdrop-blur-md">
            ...
            <div className="grid md:grid-cols-1 gap-8 text-left bg-white/5 p-8 md:p-12 rounded-2xl border border-white/10 backdrop-blur-sm">
      ...
      <section className="py-24 bg-[#0f1420] relative">
         ...
         <div className="container mx-auto px-6 relative z-10">
           ...
           <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-20 relative">
             ...
             {[
               ...
               <div key={idx} className="flex flex-col items-center text-center group">
                 <div className="w-24 h-24 bg-[#1e2532] rounded-full border-4 border-[#0b0f19] flex items-center justify-center mb-6 group-hover:border-accent transition-colors duration-300 shadow-xl">
           ...
           {/* Feature Icons */}
           <div className="grid grid-cols-2 md:grid-cols-4 gap-6 border-t border-gray-800 pt-12 max-w-5xl mx-auto">
           ...
           <div className="mt-16 text-center">
              <button 
                onClick={scrollToForm}
                className="bg-white text-primary hover:bg-gray-100 px-8 py-3 rounded-md font-bold flex items-center gap-2 mx-auto transition-colors"
              >
      ...
      <section className="py-16 bg-accent text-white text-center">
        <div className="container mx-auto px-6">
          ...
          <a 
            href="/#lead-form" 
            className="inline-block bg-[#002244] hover:bg-[#003366] text-white px-10 py-4 rounded-sm font-bold text-lg transition-colors uppercase tracking-wider"
          >
