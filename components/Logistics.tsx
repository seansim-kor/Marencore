  ...
  return (
    <section id="logistics" className="py-24 bg-deep-gradient text-white scroll-mt-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <span className="text-cyan-400 font-bold tracking-widest uppercase text-xs mb-3 block">Seamless Cold Chain</span>
        <h2 className="text-4xl md:text-5xl font-serif font-bold text-white mb-6">
          Overnight Freshness: ICN to South East Asia
        </h2>
        <p className="text-cyan-100 max-w-2xl mx-auto mb-16">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-4 relative max-w-5xl mx-auto mb-16">
          ...
          {/* Step 1 */}
          <div className="relative z-10 flex flex-col items-center bg-[#003366] border border-white/10 p-8 rounded-2xl shadow-xl md:w-1/3 min-h-[220px] transition-transform hover:-translate-y-2 duration-300">
            <div className="w-20 h-20 bg-white/10 text-cyan-300 rounded-full flex items-center justify-center mb-6 shadow-inner backdrop-blur-sm">
              <Ship size={32} />
            </div>
          ...
          {/* Step 2 */}
          <div className="relative z-10 flex flex-col items-center bg-white p-8 rounded-2xl shadow-2xl shadow-cyan-900/50 md:w-1/3 min-h-[240px] transform md:scale-105">
            <div className="absolute -top-4 bg-accent text-white text-[10px] px-4 py-1 rounded-full font-bold uppercase tracking-widest shadow-md">
              Stabilization Hub
            </div>
        ...
        <div className="max-w-4xl mx-auto bg-white/5 rounded-xl border border-white/10 p-8 flex flex-col md:flex-row items-center gap-8 backdrop-blur-md">
